...
しかし時には、同じ地図の画像を使って、会社の近くのコンビニエンスストアの場所を伝えたい場合もあるかもしれません。そのような場合は、コンビニエンスストア
に言及することになるでしょう。このように、同じ画像でも、文脈によって伝えるべきことが異なります。画像に含まれる多数の情報のうち、どこを切り取って代替テキストとするのかが腕の見せ所となります。
...
地の文で道順を示しているため、`alt`には道順を記載せずに、単にどのような画像かを記しています。冗長な情報を省くことで、スクリーンリーダーが同じ内容を二度読み上げることを防ぎます。文脈によって、代替テキストの内容は変化することがあることも念頭に置いておくとよいでしょう。
