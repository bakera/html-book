...
しかし、クロスオリジンでアクセス権限は制約されたままですと都合が悪い場合があります。そこで、ブラウザーに対してアクセス権限を与えるように追加のHTTPヘッダーを利用して指示する、CORS (Cross-Origin Resource Sharing)[^17]と呼ばれる仕組みを利用して、アクセスを許可します。
