...
リンクタイプは、現在の文書とリンク先のリソースとの関係を表すキーワードで、HTML仕様の4.6.6 Link types[^8]にて定義されています。リンクタイプのキーワードは大文字小文字を区別しません。たとえば、"stylesheet"と"StyleSheet"と"STYLESHEET"は同じ意味になります。
...
[^16]: <https://w3c.github.io/resource-hints/>。2021年9月時点ではW3C文書ですが、WHATWGに移管される予定です。
...
[^17]: <https://w3c.github.io/preload/>。2021年9月時点ではW3C文書ですが、WHATWGに移管される予定です。
